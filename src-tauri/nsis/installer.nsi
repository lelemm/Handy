; Custom NSIS template for (not)Handy with portable mode support.
...
Function .onInit
  ...
  ; or the legacy markers created by older Handy releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "(not)Handy Portable Mode"
    FileClose $0
